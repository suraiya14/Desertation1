...
#fit_control = trainControl(classProbs=TRUE,search="random")
...
rfe_fit = rfe(xtdm[,feature_names], xtdm[,target],
              ...
              ntree=400,
              metric = "ROC",
              ###dditional arguments to train method here
              trControl=trainctrl
)
...
file<-"D:\\Research Work\\Disertation Project 1\\Raw Data\\featureExtraction\\RFE\\Result\\summary_T-TEST_RF.csv"
write.csv(rfe_fit$results,file, row.names = FALSE)

file<-"D:\\Research Work\\Disertation Project 1\\Raw Data\\featureExtraction\\RFE\\Result\\optva_T-TEST_RF.csv"
